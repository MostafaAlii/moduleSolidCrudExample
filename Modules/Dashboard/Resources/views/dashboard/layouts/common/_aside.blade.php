            ...
            <div
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">المدن و المحافظات</span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">{{trans('dashboard::sidebar.departments_sections')}}</span>
                        <span class="menu-arrow"></span>
                    </span>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('section.index') }}">
                                ...
                                <span class="menu-title">{{trans('dashboard::sidebar.sections')}}</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="{{-- aurl('questions') --}}">
                                ...
                                <span class="menu-title">{{trans('dashboard::sidebar.departments')}}</span>
                            </a>
                        </div>
                    </div>
                </div>
